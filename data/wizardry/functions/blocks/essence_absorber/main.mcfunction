...
execute as @e[tag=fire-node] at @s facing entity @p[scores={FireEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=fire-node] at @s if entity @a[limit=1,distance=..1,scores={FireEssence=..50}] run kill @s
execute as @e[tag=water-node] at @s facing entity @p[scores={WaterEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=water-node] at @s if entity @a[limit=1,distance=..1,scores={WaterEssence=..50}] run kill @s
execute as @e[tag=earth-node] at @s facing entity @p[scores={EarthEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=earth-node] at @s if entity @a[limit=1,distance=..1,scores={EarthEssence=..50}] run kill @s
execute as @e[tag=air-node] at @s facing entity @p[scores={AirEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=air-node] at @s if entity @a[limit=1,distance=..1,scores={AirEssence=..50}] run kill @s
execute as @e[tag=electric-node] at @s facing entity @p[scores={ElectricEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=electric-node] at @s if entity @a[limit=1,distance=..1,scores={ElectricEssence=..50}] run kill @s
execute as @e[tag=ice-node] at @s facing entity @p[scores={IceEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=ice-node] at @s if entity @a[limit=1,distance=..1,scores={IceEssence=..50}] run kill @s
execute as @e[tag=life-node] at @s facing entity @p[scores={LifeEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=life-node] at @s if entity @a[limit=1,distance=..1,scores={LifeEssence=..50}] run kill @s
execute as @e[tag=space-node] at @s facing entity @p[scores={SpaceEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=space-node] at @s if entity @a[limit=1,distance=..1,scores={SpaceEssence=..50}] run kill @s
execute as @e[tag=death-node] at @s facing entity @p[scores={DeathEssence=..50}] feet run tp @s ^ ^ ^.1
...
execute as @e[tag=death-node] at @s if entity @a[limit=1,distance=..1,scores={DeathEssence=..50}] run kill @s