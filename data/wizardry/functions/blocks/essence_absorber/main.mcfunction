...
execute if score @s FireEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={FireEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,fire-node,wizardry-entity]}
execute if score @s FireEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={FireEssence=..49}] run scoreboard players remove @s FireEssence 1
execute if score @s WaterEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={WaterEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,water-node,wizardry-entity]}
execute if score @s WaterEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={WaterEssence=..49}] run scoreboard players remove @s WaterEssence 1
execute if score @s EarthEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={EarthEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,earth-node,wizardry-entity]}
execute if score @s EarthEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={EarthEssence=..49}] run scoreboard players remove @s EarthEssence 1
execute if score @s AirEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={AirEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,air-node]}
execute if score @s AirEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={AirEssence=..49}] run scoreboard players remove @s AirEssence 1
execute if score @s ElectricEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={ElectricEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,electric-node,wizardry-entity]}
execute if score @s ElectricEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={ElectricEssence=..49}] run scoreboard players remove @s ElectricEssence 1
execute if score @s IceEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={IceEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,ice-node,wizardry-entity]}
execute if score @s IceEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={IceEssence=..49}] run scoreboard players remove @s IceEssence 1
execute if score @s LifeEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={LifeEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,life-node,wizardry-entity]}
execute if score @s LifeEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={LifeEssence=..49}] run scoreboard players remove @s LifeEssence 1
execute if score @s SpaceEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={SpaceEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,space-node,wizardry-entity]}
execute if score @s SpaceEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={SpaceEssence=..49}] run scoreboard players remove @s SpaceEssence 1
execute if score @s DeathEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={DeathEssence=..49}] run summon minecraft:armor_stand ~ ~-1.1 ~ {Small:1b,Marker:1b,Invisible:1b,NoGravity:1b,Tags:[essence-node,death-node,wizardry-entity]}
execute if score @s DeathEssence matches 1.. if entity @e[distance=..7,tag=essence-holder,scores={DeathEssence=..49}] run scoreboard players remove @s DeathEssence 1
